      ...
      {props.notify == 'true' ? (
        <Switch
          style={{
            ...
            right: '3%',
            transform: [
              {scaleX: scalableheight.borderTopWidth},
              {scaleY: scalableheight.borderTopWidth},
            ],
          }}
          ...
          <View
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                alignItems: 'center',
                justifyContent: 'center',
                backgroundColor: Language == 'English' ? '#C59E6E' : '#F9F9F9',
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                alignItems: 'center',
                justifyContent: 'center',
                backgroundColor: Language == 'Arabic' ? '#C59E6E' : '#F9F9F9',
                borderBottomLeftRadius: 24,
                borderBottomRightRadius: 24,
              }}>
              <Text
                style={{
                  color: Language == 'Arabic' ? 'white' : 'black',
                  fontSize: fontSize.fourteen,
                  fontFamily: 'Rubik-Medium',
                }}>
                Arabic
