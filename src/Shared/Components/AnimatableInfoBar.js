...
const navigation = useNavigation();
  ...
  return (
    <View style={{...styleSheet.shadow, flexDirection:"row", width:"100%", height: "100%", backgroundColor:"white", borderRadius: fontSize.borderradiusmedium, }}>
    <View style={{height: "100%", width: "20%", alignItems:"center", justifyContent:"center"}}>
<View style={{height: "80%", width: scalableheight.six, backgroundColor:"rgba(211,211,211, 0.3)",  borderRadius: fontSize.borderradiusmedium, alignItems:"center", justifyContent:"center"}}>
<MaterialIcons 
            name="location-pin"
            color={'#F55050'}
