...
import { View, Text, TextInput, Image, ImageBackground, StyleSheet, TouchableOpacity, KeyboardAvoidingView, SafeAreaView, StatusBar, Keyboard } from 'react-native';
...
import { eraselogin, erasesignup, signUp } from '../Actions/actions';
...
const SignUp = ({ navigation }) => {
  ...
  const [confrimPasswordActive, setConfrimPasswordActive] = useState(false);
  const [userName, setUserName] = useState("");
  const [phoneNumber, setphoneNumber] = useState("");
  const [emailAddress, setEmailAddress] = useState("");
  const [password, setPassword] = useState("");
  const [confrimPassword, setConfirmPassword] = useState("");
  const { Lang, SignUp } = useSelector(state => state.userReducer);
  ...
  useEffect(() => {
    setLoader(false);
    if (SignUp == 200) {
      showToast("Account created! Please wait for OTP verification", {
        duration: 500,
      });
      setTimeout(async () => {
  ...
  const handleSubmit = () => {
    ...
    // const PhoneNumber = selectNumber + number.trim();
    Keyboard.dismiss();
    if (userName == "") {
      showToast(
        Lang == 'en' ? 'Please enter Name.' : 'الرجاء إدخال الاسم ...',
        {
          duration: 500,
        },
      );
      ...
      console.log("RUN")
      showToast(
        Lang == 'en' ? 'Please enter Phone no.' : 'أدخل رقم الجوال ...',
        {
          duration: 500,
        },
      );
      ...
      showToast(
        Lang == 'en' ? 'Please enter Password' : 'أدخل كلمة المرور ...',
        {
          duration: 500,
        },
      );
      ...
      showToast(
        Lang == 'en' ? 'Please enter Confirm Password.' : 'الرجاء إدخال تأكيد كلمة المرور ...',
        {
          duration: 500,
        },
      );
      ...
      showToast(
        Lang == 'en' ? 'Password and Confirm Password does not match.' : 'كلمة المرور وتأكيد كلمة المرور غير متطابقين ...',
        {
          duration: 500,
        },
      );
      ...
      NetInfo.fetch().then(state => {
        if (state.isConnected == false && state.isInternetReachable == false) {
          ...
          const data = {
            ...
            Password: password,
            Contact: phoneNumber,
            PhoneCode: selectNumber.substring(1),
          }
  ...
  return (
    ...
    <View style={{ height: "100%", width: "100%", backgroundColor: "white" }}>
      ...
      behavior={Platform.OS === 'ios' ? 'padding' : 'padding'}>
          ...
          <ScrollView
            showsVerticalScrollIndicator={false}
            style={{ alignContent: "center", width: "100%", marginBottom: Platform.OS === 'ios' ? scalableheight.two : null}}>
            ...
            <View style={{ position: 'relative', width: '100%' }}>
              <MyInput
                ...
                placeHolder={
                  Lang == 'en' ? 'Enter phone number here' : 'أدخل الرقم هنا.'
                }
              />
            ...
            <View style={{ position: 'relative', width: "100%", alignSelf: "center", }}>
              <TextInput
                style={[styles.inputStyle, { backgroundColor: userNameActive || userName !== "" ? "#FFF" : "transparent" }]}
                value={userName}
                placeholder={"Name"}
            ...
            <View style={{ position: 'relative', width: "100%", alignSelf: "center" }}>
              <TextInput
                style={[styles.inputStyle, { backgroundColor: emailAddressActive || emailAddress !== "" ? "#FFF" : "transparent" }]}
                value={emailAddress}
                ...
                onFocus={() => setEmailAddressActive(true)}
                onBlur={() => setEmailAddressActive(false)}
              />
              <View style={styles.inputIconStyle}>
                <MaterialIcons
                  color={'#818181'}
            ...
            <View style={{ position: 'relative', width: "100%", alignSelf: "center" }}>
              <TextInput
                style={[styles.inputStyle, { backgroundColor: passwordActive || password !== "" ? "#FFF" : "transparent" }]}
                value={password}
            ...
            <View style={{ position: 'relative', width: "100%", alignSelf: "center" }}>
              <TextInput
                style={[styles.inputStyle, { backgroundColor: confrimPasswordActive || confrimPassword !== "" ? "#FFF" : "transparent" }]}
                ...
                onFocus={() => setConfrimPasswordActive(true)}
                onBlur={() => setConfrimPasswordActive(false)}
              />
              <TouchableOpacity
            ...
            <View style={{ width: "100%", alignSelf: "center", marginTop: "6%" }}>
              <CustomButton
                title={Lang == "en" ? "Sign Up" : "اشتراك"}
          ...
          style={{
            flexDirection: Lang == "en" ? "row" : "row-reverse", fontFamily: "Rubik-Regular",

            alignItems: 'center', justifyContent: "center"
          }}>

          <Text style={{ fontSize: fontSize.fourteen, color: "#B3B3B3" }}>
            {Lang == "en" ? "Already have an account ?" : "هل لديك حساب ؟"}
          </Text>
          <Text style={{ fontSize: fontSize.fourteen, color: "white", marginLeft: Lang == "en" ? "2%" : "0%", marginRight: Lang == "en" ? "0%" : "2%" }}>
