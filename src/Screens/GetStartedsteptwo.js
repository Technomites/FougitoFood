...
const GetStartedsteptwo = props => {
  ...
  return (
    <View
      ...
      <ImageBackground
        resizeMode="cover"
        source={require('../Resources/images/GetstartedS2.png')}
        ...
        <View
          ...
          <Text
            ...
            Why go out when you can have food delivered to your doorstep
          </Text>
          <View
            style={{
              flexDirection: 'row',
          ...
          <View
            style={{width: '100%', padding: scalableheight.two, marginTop: 0}}>
            <MYButton
              color={'#E14E4E'}
              title="NEXT"
              textcolor={'white'}
