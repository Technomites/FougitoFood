...
import {changelang, seticonfocus, submitcontactusform, clearcontactform, getbussinesssettings} from '../Actions/actions';
...
const ContactUs = ({navigation, drawerAnimationStyle}) => {
  ...
  const [LocationData, setLocationData] = useState([
    {
      name: 'Dubai',
      number: '+971 32209887',
      description: '121 Mostafa El Nahas St., 24k Dubai',
      image: require('../Resources/images/contactlocations.png'),
    },
    {
      name: 'Dubai',
      number: '0331209887',
  ...
  const {Lang, contactformsubmissionsuccess, bussinesslist} = useSelector(state => state.userReducer);
...
setLoader(false)
  if(contactformsubmissionsuccess == 200){
    showToast(Lang == "en" ? "Your email has been sent successfully. We will getback to you shortly" : "تم إرسال بريدك الإلكتروني بنجاح ، وسنعاود الاتصال بك قريبًا."    , {
      duration: 500,
    });
    ...
    showToast(Lang == "en" ? "There was a problem sending your email. Please try again later." : "حدثت مشكلة أثناء إرسال البريد الإلكتروني الخاص بك. يرجى المحاولة مرة أخرى في وقت لاحق.", {
      duration: 500,
    });
  }
  ...
  function submitcontactus(){
    if(FirstName == ""){
      showToast(Lang == "en" ? "Please enter your first name." : "الرجاء إدخال اسمك الأول.", {
        duration: 500,
      });
    }else if(PhoneNumber == ""){
      showToast(Lang == "en" ? "Please enter your phone number." : "يرجى إدخال رقم الهاتف الخاص بك.", {
        duration: 500,
      });
    }else if(Email == ""){
      showToast(Lang == "en" ? "Please enter your email address." : "الرجاء إدخال عنوان البريد الإلكتروني الخاص بك.", {
        duration: 500,
      });
    }else if(Message == ""){
      showToast(Lang == "en" ? "Please enter your message." : "أدرج رسالتك من فضلك.", {
        duration: 500,
      });
    }else{
      setLoader(true)
...
marginTop: scalableheight.one,
      ...
      <View
        ...
        <TouchableOpacity
        onPress={() => {Linking.openURL(`tel:${item.contact1}`)}}
          style={{
            width: '70%',
            height: '13%',
            backgroundColor: 'white',
  ...
  return (
    <Animated.View
      ...
      <View
        ...
        <PlainHeader title={Lang == 'en' ? 'Our Locations' : 'مواقعنا'} />
        <View
          style={{
          ...
          <ScrollView
            showsVerticalScrollIndicator={false}
            style={{height: '65%',marginTop: scalableheight.one,}}>
            <View
              style={{
                width: '100%',
                height: '100%',
              ...
              <Text
                ...
                {Lang == 'en' ? 'Lets Connect With Us' : 'لنتواصل معنا'}
              </Text>
              <View style={{width: '90%'}}>
                <View
                  style={{
                  ...
                  />
                  {renderIf(Lang == 'en')(
                    <View style={styleSheet.inputIconStyle}>
                      <Feather
                        color={'#818181'}
                        name="user"
                ...
                <View
                  ...
                  <TextInput
                    ...
                    value={Email}
                    placeholder={
                      Lang == 'en' ? 'Email Address' : 'عنوان بريد الكتروني'
                    }
                    placeholderTextColor={'#A0A0A0'}
                    placeholderStyle={styleSheet.placeholderStyle}
...
height:scalableheight.fifteen,
                   ...
                   multiline
                    placeholder={
                      Lang == 'en' ? 'Type your message' : 'اكتب رسالتك'
                    }
                    numberOfLines={8}
                    placeholderTextColor={'#A0A0A0'}
                    placeholderStyle={styleSheet.placeholderStyle}
...
<ActivityIndicator
      ...
      <View
        style={{
          flex: 1,
          backgroundColor: 'white',
          borderBottomLeftRadius: fontSize.eleven,
          borderBottomRightRadius: fontSize.eleven,
        }}>
        <BottomTab />
      </View>
